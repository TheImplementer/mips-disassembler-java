...
public class LwInstruction implements Instruction {
    ...
    public LwInstruction(Register rt, Register rs, short immediate) {
        this.rt = rt;
        this.rs = rs;
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof LwInstruction)) {
            return false;
        }
        final LwInstruction other = (LwInstruction) obj;
    ...
    public String toString() {
        return String.format("lw %s, 0x%02x(%s)", rt, immediate, rs);
    }
}
