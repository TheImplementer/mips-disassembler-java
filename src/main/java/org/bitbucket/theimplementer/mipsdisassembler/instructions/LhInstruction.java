...
public class LhInstruction implements Instruction {
    ...
    public LhInstruction(Register rt, Register rs, short immediate) {
        this.rt = rt;
        this.rs = rs;
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof LhInstruction)) {
            return false;
        }
        final LhInstruction other = (LhInstruction) obj;
    ...
    public String toString() {
        return String.format("lh %s, 0x%02x(%s)", rt, immediate, rs);
    }
}
